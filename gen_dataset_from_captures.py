...
def detect_delay(dry_wav: Path, wet_wav: Path) -> tuple:
    ...
    to the raw-capture path. Never a correlation-based guess (see capture_static.py's module
    docstring for why that actively misleads) -- only NAM's own impulse-based calibration, or a
    disclosed delay=0.
