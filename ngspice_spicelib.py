...
def load_input(infile, vin, tmp, src_name='input.src'):
    ...
    intentionally sit at different absolute levels (the --sweep-file clip at --sweep-peak,
    chirps at each of --chirp-levels) -- rescaling by the file's own peak would flatten that
